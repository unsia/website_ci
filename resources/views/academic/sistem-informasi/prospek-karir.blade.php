...
@section('contentBox')<div class="row">
    <!-- Your Profile Views Chart -->
    <div class="col-lg-12 m-b30">
        <div class="widget-box">
            <div class="wc-title">
                <h6>Kompetensi Utama Lulusan Program Studi Sistem Informasi</h6>
            </div>
            ...
            <div class="widget-inner">
                <table class="table table-borderless">
                    <tbody>
                        <tr>
                            <th scope="row">1</th>
                            <td>Information System Manager (IS Manager)</td>
                        </tr>
                        <tr>
                            <th scope="row">2</th>
                            <td>Information Technology Manager (IT Manager)</td>
                        </tr>
                        <tr>
                            <th scope="row">3</th>
                            <td>Information System Development Project Manager</td>
                        </tr>
                        <tr>
                            <th scope="row">4</th>
                            <td>Database dan E-Business Manager</td>
                        </tr>
                        <tr>
                            <th scope="row">5</th>
                            <td>IT/IS Consultant</td>
                        </tr>
                        <tr>
                            <th scope="row">6</th>
