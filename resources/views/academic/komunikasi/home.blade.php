	...
	<div class="col-lg-8 m-b30">
		<div class="widget-box">
			...
			<div class="widget-inner">
				<div class="js-player" data-plyr-provider="youtube" data-plyr-embed-id="https://www.youtube.com/watch?v=kzDxmRmm6PA&t=7s"></div>
			</div>
		</div>
	</div>
</div>
        ...
        <div class="widget-box">
            ...
            <div class="widget-inner">
                <table class="table table-bordered">
                    ...
                    <tr>
                        <th>Website</th>
                        <td><a href="{{ url('komunikasi') }}">http://unsia.ac.id/akademik/program-studi/komunikasi</a>
                        </td>
                    </tr>
                    <tr>
                        <th>Jenjang</th>
