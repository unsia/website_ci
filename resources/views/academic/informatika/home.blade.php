	...
	<div class="col-lg-8 m-b30">
		<div class="widget-box">
			...
			<div class="widget-inner">
				<div class="js-player" data-plyr-provider="youtube" data-plyr-embed-id="9sUC4uOqgo0"></div>
			</div>
		</div>
	</div>
</div>
        ...
        <div class="widget-box">
            ...
            <div class="widget-inner">
                <table class="table table-bordered">
                    ...
                    <tr>
                        <th>Website</th>
                        <td><a href="{{ url('informatika') }}">http://unsia.ac.id/akademik/program-studi/informatika</a>
                        </td>
                    </tr>
                    <tr>
                        <th>Jenjang</th>
