...
@section('title')
    {{ config('app.name', 'Brainloka') }} | {{ count($current_menu) > 0 ? $current_menu[count($current_menu) - 1] : 'Pengguna' }}
@endsection
    ...
    <div class="row">
        <div class="col-xl-8">
            <div class="kt-portlet">
                ...
                <form class="kt-form kt-form--label-right" method="POST" action="{{ route('users.store') }}" enctype="multipart/form-data" id="practice-form">
                    @csrf
                        ...
                        <div class="kt-section kt-section--first">
                            <div class="kt-section__body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9 col-xl-6">
                                        <div class="kt-avatar kt-avatar--outline kt-avatar--circle" id="kt_apps_user_add_avatar">
                                            <img class="kt-avatar__holder" src="{{ old('foto') }}" id="foto" onerror="this.src='{{ asset('img/blank-avatar.png') }}'">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9 col-xl-6">
                                        <input class="form-control {{ $errors->has('nama') ? 'is-invalid' : '' }}" name="nama" type="text" value="{{ old('nama') }}"  placeholder="Nama Lengkap">
                                        @if($errors->has('nama'))
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9 col-xl-6">
                                        <input class="form-control {{ $errors->has('akun') ? 'is-invalid' : '' }}" name="akun" type="text" value="{{ old('akun') }}" placeholder="Nama Akun">
                                        @if($errors->has('akun'))
                                    ...
                                    <div class="col-lg-9 col-xl-6">
                                        <select class="form-control provinsi" type="text" placeholder="Provinsi" name="id_role">
                                            ...
                                            @foreach($roles as $item)
                                                <option value="{{ $item->id }}" {{ old('id_role') == $item->id ? 'selected' : ''}}>{{ $item->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9 col-xl-6">
                                        <input class="form-control {{ $errors->has('tempat_lahir') ? 'is-invalid' : '' }}" name="tempat_lahir" type="text" value="{{ old('tempat_lahir') }}" placeholder="Tempat Lahir">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9 col-xl-6">
                                        <input class="form-control" type="text" readonly id="tanggal_lahir" value="{{ old('tanggal_lahir') }}" placeholder="Tanggal Lahir">
                                    </div>
                                </div>
                                    ...
                                    <div class="col-lg-9 col-xl-6">
                                        <div class="kt-radio-inline">
                                            <label class="kt-radio kt-radio--solid kt-radio--primary">
                                                <input type="radio" {{ old('kelamin') == 'l' ? 'checked' : '' }} name="kelamin" value="l"> Laki - Laki
                                                <span></span>
                                            </label>
                                            <label class="kt-radio kt-radio--solid kt-radio--warning">
                                                <input type="radio" {{ old('kelamin') == 'p' ? 'checked' :'' }} name="kelamin" value="p"> Perempuan
                                                <span></span>
                                            </label>
                                        </div>
                                    </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9 col-xl-6">
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="telepon" class="form-control" value="{{ old('telepon') }}" placeholder="Telepon">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9 col-xl-6">
                                        <textarea class="form-control" placeholder="Alamat" rows="4" name="alamat">{{ old('alamat') }}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
