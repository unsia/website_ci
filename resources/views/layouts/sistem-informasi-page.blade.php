...
<div class="ttr-sidebar">
    <div class="ttr-sidebar-wrapper content-scroll">
        ...
        <nav class="ttr-sidebar-navi">
            <ul>
                <li>
                    <a href="{{ route('sistem-informasi') }}" class="ttr-material-button">
                        <span class="ttr-icon"><i class="ti-home"></i></span>
                        <span class="ttr-label">Dashboard</span>
                    </a>
                </li>
                <li>
                    <a href="{{ route('sistem-informasi.profil') }}" class="ttr-material-button">
                        <span class="ttr-icon"><i class="ti-write"></i></span>
                        <span class="ttr-label">Profil</span>
                    </a>
                </li>
                <li>
                    <a href="{{ route('sistem-informasi.kurikulum') }}" class="ttr-material-button">
                        <span class="ttr-icon"><i class="ti-book"></i></span>
                        <span class="ttr-label">Kurikulum</span>
                    </a>
                </li>
                <li>
                    <a href="{{ route('sistem-informasi.keunggulan') }}" class="ttr-material-button">
                        <span class="ttr-icon"><i class="ti-cup"></i></span>
                        <span class="ttr-label">Keunggulan</span>
                    </a>
                </li>
                <li>
                    <a href="{{ route('sistem-informasi.prospek_karir') }}" class="ttr-material-button">
                        <span class="ttr-icon"><i class="ti-medall"></i></span>
                        <span class="ttr-label">Prospek Karir</span>
                    </a>
                </li>
                <li>
                    <a href="{{ route('sistem-informasi.dosen') }}" class="ttr-material-button">
                        <span class="ttr-icon"><i class="ti-user"></i></span>
                        <span class="ttr-label">Dosen</span>
                    </a>
                </li>
                <li>
                    <a href="{{ route('sistem-informasi.profil_lulusan') }}" class="ttr-material-button">
                        <span class="ttr-icon"><i class="ti-clipboard"></i></span>
                        <span class="ttr-label">Profil Lulusan</span>
                    </a>
                </li>
                <li>
                    <a href="{{ route('sistem-informasi.capaian_pembelajaran_lulusan') }}" class="ttr-material-button">
                        <span class="ttr-icon"><i class="ti-stats-up"></i></span>
                        <span class="ttr-label">Capaian Pembelajaran Lulusan</span>
                    </a>
                </li>
            </ul>
            <!-- sidebar menu end -->
