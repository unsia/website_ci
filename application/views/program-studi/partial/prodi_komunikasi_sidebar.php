...
<div class="ttr-sidebar">
    <div class="ttr-sidebar-wrapper content-scroll">
        ...
        <nav class="ttr-sidebar-navi">
            <ul>
                <li>
                    <a href="<?= base_url('program-studi/komunikasi') ?>" class="ttr-material-button">
                        <span class="ttr-icon"><i class="ti-home"></i></span>
                        <span class="ttr-label">Dashboard</span>
                    </a>
                </li>
                <li>
                    <a href="<?= base_url('program-studi/komunikasi/dosen') ?>" class="ttr-material-button">
                        <span class="ttr-icon"><i class="ti-user"></i></span>
                        <span class="ttr-label">Dosen</span>
                    </a>
                </li>
                <li>
                    <a href="<?= base_url('program-studi/komunikasi/keunggulan') ?>" class="ttr-material-button">
                        <span class="ttr-icon"><i class="ti-cup"></i></span>
                        <span class="ttr-label">Keunggulan</span>
                    </a>
                </li>
                <li>
                    <a href="<?= base_url('program-studi/komunikasi/kurikulum') ?>" class="ttr-material-button">
                        <span class="ttr-icon"><i class="ti-book"></i></span>
                        <span class="ttr-label">Kurikulum</span>
                    </a>
                </li>
                <li>
                    <a href="<?= base_url('program-studi/komunikasi/prospek_karir') ?>" class="ttr-material-button">
