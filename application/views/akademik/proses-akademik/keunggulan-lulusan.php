                ...
                <div class="col-lg-12 col-md-12 col-sm-12 m-b30">
                    <div class="feature-container">
                        <div class="icon-content mb-2">
                            <p style="text-align: justify">Lulusan Universitas Siber Asia dengan metode
                                pembelajaran online via Learning Management System (LMS) menghasilkan
                                lulusan yang mampu menguasai teknologi informasi sebagai basis pengembangan
                                Applied Science di berbagai Program Studi yang ditawarkan. Kemandirian dan
                                Kreatifitas/Inovasi adalah kata kunci yang menjadi target utama capaian
                                pembelajaran lulusan. Karakteristik lulusan tersebut dicapai dengan proses
                            ...
                            <p style="text-align: justify">Branding utama Universitas Siber Asia adalah
                                ...
                                Informasi pada level Developer. Dengan demikian, mahasiswa di prodi-prodi
