<div class="row">
    ...
    <div class="col-lg-6 m-b30">
        <div class="widget-box">
            <div class="wc-title">
                <h4>SEBARAN MATA KULIAH PROGRAM STUDI AKUNTANSI 2020</h4>
            </div>
            <div class="widget-inner">
