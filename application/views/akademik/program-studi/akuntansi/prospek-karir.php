            ...
            <div class="widget-inner">
                ...
                <table class="table table-bordered">
                    ...
                    <tr>
                        ...
                        <td>
                            <p style="text-align: justify">Mampu dan menguasai dan mengerti konsep akuntansi, sistem informasi akuntansi serta memahami proses audit laporan keuangan dan melakukan pemeriksaan laporan keuangan baik di sektor swasta dan nonswasta sesuai standar akuntansi yang berlaku di Indonesia SAP dan IPSAS</p>
                        </td>
                    </tr>
                    <tr>
                        <td>2</td>
                        ...
                        <td>
                            <p style="text-align: justify">Mampu dan menguasai dan mengerti serta dapat menyusun dan menganalisis laporan akuntansi manajemen ,meliputi perencanaan dan penganggaran,manajemen biaya,pengendalian kualitas,pengukuran kinerja dan benchmarking yang relevan dan handal dalam mendukung pengambilan keputusan dan pengendalian manajemen dengan menerapkan teknik-teknik akuntansi manajemen</p>
                        </td>
                    </tr>
                    <tr>
                        <td>3</td>
                    ...
                    <tr>
                        ...
                        <td>
                            <p style="text-align: justify">Mampu dan menguasai dan mengerti serta dapat menghitung seluruh perhitungan pajak sesuai dengan Undang-Undang perpajakan yang berlaku</p>
                        </td>
                    </tr>
                    <tr>
                        <td>5</td>
                        ...
                        <td>
                            <p style="text-align: justify">Mampu dan menguasai serta dapat menerapkan semua ilmu akuntansi dalam bidang pendidikan akuntansi</p>
                        </td>
                    </tr>
                </table>
            </div>
