<div class="row">
    ...
    <div class="col-lg-6 m-b30">
        <div class="widget-box">
            ...
            <div class="widget-inner">
                <p style="text-align: justify">Dengan penerapan KPT-KKNI level 6, Manajemen telah
                    ...
                    diakui oleh Universitas Siber Asia sebagai pelengkap pencapaian learning outcome. Sistem
                    recognition atau
                    ...
                    Manajemen berupaya konsisten dalam membangun mutu lulusan di
                    bidang
                    manajemen</p>
            </div>
        </div>
    ...
    <div class="col-lg-6 m-b30">
        <div class="widget-box">
            <div class="wc-title">
                <h4>SEBARAN MATA KULIAH PROGRAM STUDI MANAJEMEN 2020</h4>
            </div>
            <div class="widget-inner">
                <p>Jumlah sks Program Studi (minimum untuk kelulusan) : 144 sks yang tersusun
                    sebagai berikut:</p>
                <P>- Download File</P>
                <a href="<?= base_url(); ?>assets/documents/Kurikulum Program Studi Manajemen Kontemporer.pdf" class="btn btn-primary">KURIKULUM</a>
                <a href="<?= base_url(); ?>assets/documents/Deskripsi Mata Kuliah Manajemen Kontemporer.pdf" class="btn btn-primary">DESKRIPSI MATA KULIAH</a>
            </div>
        </div>
    </div>
</div>
