            ...
            <div class="ttr-logo-box">
                <div>
                    <a href="<?= base_url(); ?>" class="ttr-logo">
                        <img class="ttr-logo-mobile" alt="" src="<?= base_url(); ?>assets/images/logo-mobile.png" width="30" height="30">
                        <img class="ttr-logo-desktop" alt="" src="<?= base_url(); ?>assets/images/logo-white.png" width="160" height="27">
                    </a>
                </div>
            </div>
            <!--logo end -->
