...
<head>
    ...
    <meta property="og:site_name" content="Universitas Siber Asia" /> <!-- website name -->
    <meta property="og:site" content="http://localhost/website_ci/home/event/htc" /> <!-- website link -->
    <meta property="og:title" content="Universitas Siber Asia - HTC" /> <!-- title shown in the actual shared post -->
    <meta property="og:description" content="Universitas Siber Asia - HTC" /> <!-- description shown in the actual shared post -->
    <meta property="og:image" content="" /> <!-- image link, make sure it's jpg -->
    <meta property="og:url" content="" /> <!-- where do you want your post to link to -->
    <meta property="og:type" content="article" />

    <!-- Website Title -->
    <title>Universitas Siber Asia - HTC</title>

    <!-- Styles -->
    <link href="https://fonts.googleapis.com/css?family=Open+Sans:400,400i,700&display=swap&subset=latin-ext" rel="stylesheet">
    <link href="<?= base_url(); ?>assets/home/event/htc/css/bootstrap.css" rel="stylesheet">
    <link href="<?= base_url(); ?>assets/home/event/htc/css/fontawesome-all.css" rel="stylesheet">
    <link href="<?= base_url(); ?>assets/home/event/htc/css/swiper.css" rel="stylesheet">
    <link href="<?= base_url(); ?>assets/home/event/htc/css/magnific-popup.css" rel="stylesheet">
    <link href="<?= base_url(); ?>assets/home/event/htc/css/styles.css" rel="stylesheet">
...
<body data-spy="scroll" data-target=".fixed-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark navbar-custom fixed-top">
        <div class="container">
            ...
            <!-- Image Logo -->
            <a class="navbar-brand logo-image" href="index.html"><img src="<?= base_url(); ?>assets/images/logo-white.png" alt="alternative"></a>
            ...
            <div class="collapse navbar-collapse" id="navbarsExampleDefault">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link page-scroll" href="#features">TUJUAN</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link page-scroll" href="#details">MANFAAT</a>
                    </li>
                    <li class="nav-item">
        ...
        <div class="header-content">
            ...
            <?php if (validation_errors()) : ?>
                <div class="alert alert-danger alert-dismissible fade show d-block" role="alert">
                    ...
                    <a href="#form" class="badge badge-danger">silahkan ulangi!</a>
                </div>
            <?php endif; ?>
                <div class="row">
                    <div class="col-lg-6 col-xl-5">
                        <div class="text-container">
                            <h1>UNSIA GATHERING</h1>
                            <p class="p-large">Use Tivo to automate your marketing actions in order to reach a much larger audience</p>
                            <a class="btn-solid-lg page-scroll" href="#form">JOIN US</a>
                        </div> <!-- end of text-container -->
                    </div> <!-- end of col -->
                    <div class="col-lg-6 col-xl-7">
                        <div class="image-container">
                            <div class="img-wrapper">
                                <img class="img-fluid" src="<?= base_url(); ?>assets/home/event/htc/images/header-software-app.png" alt="alternative">
                        ...
                        <div class="swiper-container image-slider">
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <img class="img-fluid" src="<?= base_url(); ?>assets/home/event/htc/images/customer-logo-1.png" alt="alternative">
                                </div>
                                <div class="swiper-slide">
                                    <img class="img-fluid" src="<?= base_url(); ?>assets/home/event/htc/images/customer-logo-2.png" alt="alternative">
                                </div>
                                <div class="swiper-slide">
                                    <img class="img-fluid" src="<?= base_url(); ?>assets/home/event/htc/images/customer-logo-3.png" alt="alternative">
                                </div>
                                <div class="swiper-slide">
                                    <img class="img-fluid" src="<?= base_url(); ?>assets/home/event/htc/images/customer-logo-4.png" alt="alternative">
                                </div>
                                <div class="swiper-slide">
                                    <img class="img-fluid" src="<?= base_url(); ?>assets/home/event/htc/images/customer-logo-5.png" alt="alternative">
                                </div>
                                <div class="swiper-slide">
                                    <img class="img-fluid" src="<?= base_url(); ?>assets/home/event/htc/images/customer-logo-6.png" alt="alternative">
                                </div>
                ...
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-image">
                            <img class="img-fluid" src="<?= base_url(); ?>assets/home/event/htc/images/description-1.png" alt="alternative">
                        </div>
                        <div class="card-body">
                    ...
                    <div class="card">
                        <div class="card-image">
                            <img class="img-fluid" src="<?= base_url(); ?>assets/home/event/htc/images/description-2.png" alt="alternative">
                        </div>
                        <div class="card-body">
                    ...
                    <div class="card">
                        <div class="card-image">
                            <img class="img-fluid" src="<?= base_url(); ?>assets/home/event/htc/images/description-3.png" alt="alternative">
                        </div>
                        <div class="card-body">
                    ...
                    <div class="tab-content" id="argoTabsContent">
                        ...
                        <div class="tab-pane fade show active" id="tab-1" role="tabpanel" aria-labelledby="tab-1">
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="image-container">
                                        <img class="img-fluid" src="<?= base_url(); ?>assets/home/event/htc/images/features-1.png" alt="alternative">
                                    </div> <!-- end of image-container -->
                                </div> <!-- end of col -->
                                <div class="col-lg-6">
                                    <div class="text-container">
                        ...
                        <div class="tab-pane fade" id="tab-2" role="tabpanel" aria-labelledby="tab-2">
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="image-container">
                                        <img class="img-fluid" src="<?= base_url(); ?>assets/home/event/htc/images/features-2.png" alt="alternative">
                                    </div> <!-- end of image-container -->
                                </div> <!-- end of col -->
                                <div class="col-lg-6">
                                    <div class="text-container">
                        ...
                        <div class="tab-pane fade" id="tab-3" role="tabpanel" aria-labelledby="tab-3">
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="image-container">
                                        <img class="img-fluid" src="<?= base_url(); ?>assets/home/event/htc/images/features-3.png" alt="alternative">
                                    </div> <!-- end of image-container -->
                                </div> <!-- end of col -->
                                <div class="col-lg-6">
                                    <div class="text-container">
    ...
    <div id="details-lightbox-1" class="lightbox-basic zoom-anim-dialog mfp-hide">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-8">
                    <div class="image-container">
                        <img class="img-fluid" src="<?= base_url(); ?>assets/home/event/htc/images/details-lightbox.png" alt="alternative">
                    </div> <!-- end of image-container -->
                </div> <!-- end of col -->
                <div class="col-lg-4">
                    <h3>List Building</h3>
    ...
    <div id="details" class="basic-1">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="image-container">
                        <img class="img-fluid" src="<?= base_url(); ?>assets/home/event/htc/images/details.png" alt="alternative">
                    </div> <!-- end of image-container -->
                </div> <!-- end of col -->
            </div> <!-- end of row -->
        </div> <!-- end of container -->
                    ...
                    <div class="image-container">
                        <div class="video-wrapper">
                            <a class="popup-youtube" href="https://www.youtube.com/watch?v=fLCjQJCekTs" data-effect="fadeIn">
                                <img class="img-fluid" src="<?= base_url(); ?>assets/home/event/htc/images/video-image.png" alt="alternative">
                            ...
                            <div class="swiper-wrapper">
                                ...
                                <div class="swiper-slide">
                                    <div class="image-wrapper">
                                        <img class="img-fluid" src="<?= base_url(); ?>assets/home/event/htc/images/testimonial-1.jpg" alt="alternative">
                                ...
                                <div class="swiper-slide">
                                    <div class="image-wrapper">
                                        <img class="img-fluid" src="<?= base_url(); ?>assets/home/event/htc/images/testimonial-2.jpg" alt="alternative">
                                    </div> <!-- end of image-wrapper -->
                                    <div class="text-wrapper">
                                ...
                                <div class="swiper-slide">
                                    <div class="image-wrapper">
                                        <img class="img-fluid" src="<?= base_url(); ?>assets/home/event/htc/images/testimonial-3.jpg" alt="alternative">
                                    </div> <!-- end of image-wrapper -->
                                    <div class="text-wrapper">
                                ...
                                <div class="swiper-slide">
                                    <div class="image-wrapper">
                                        <img class="img-fluid" src="<?= base_url(); ?>assets/home/event/htc/images/testimonial-4.jpg" alt="alternative">
                                    </div> <!-- end of image-wrapper -->
                                    <div class="text-wrapper">
    ...
    <div class="form" id="form">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="text-container">
                        <div class="above-heading">FORM KEHADIRAN</div>
                        <?php foreach ($htc as $htc) : ?>
                         
                        <h2>Stay Updated With The Latest News To Get More Qualified Leads</h2>

                        <!-- Newsletter Form -->
                        <form method="post" action="<?= base_url('home/event/htc'); ?>">
                            <div class="form-group">
                                <label for="">Nama Lengkap</label>
                                <input type="text" class="form-control" id="nama" name="nama" placeholder="Nama Lengkap" value="<?= set_value('nama'); ?>">
                                <?= form_error('nama', '<div class="badge badge-warning" role="alert">', '</div>'); ?>
                            </div>
                            <div class="form-group">
                                <label for="">NIM</label>
                                <input type="number" class="form-control" id="nim" name="nim" placeholder="NIM" value="<?= set_value('nim'); ?>">
                                <?= form_error('nim', '<div class="badge badge-warning" role="alert">', '</div>'); ?>
                            </div>
                            <div class="form-group">
                                <label for="">No. Handphone</label>
                                <input type="number" class="form-control" id="phone" name="phone" placeholder="No. Handphone" value="<?= set_value('phone'); ?>">
                                <?= form_error('phone', '<div class="badge badge-warning" role="alert">', '</div>'); ?>
                                <small id="emailHelp" class="form-text text-muted">pastikan terdaftar pada whatsapp.</small>
                            </div>
                            <div class="form-group">
                                <label for="">Email</label>
                                <input type="email" class="form-control" id="email" name="email" aria-describedby="emailHelp" placeholder="Email" value="<?= set_value('email'); ?>">
                                <?= form_error('email', '<div class="badge badge-warning" role="alert">', '</div>'); ?>
                            </div>
                            <div class="form-group">
                                ...
                                <?= form_error('prodi', '<div class="badge badge-warning" role="alert">', '</div>'); ?>
                            </div>
                            <div class="form-group">
                                ...
                                <?= form_error('kehadiran', '<div class="badge badge-warning" role="alert">', '</div>'); ?>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                            <small id="emailHelp" class="form-text text-muted">(apabila hadir offline) Saya bersedia membawa hasil swab test antigen</small>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" id="swab" name="swab" value="Ya">
                                    <label class="form-check-label" for="inlineRadio1">Ya</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" id="swab" name="swab" value="Tidak">
                                    <label class="form-check-label" for="inlineRadio2">Tidak</label>
                                </div>
                                <?= form_error('swab', '<div class="badge badge-warning" role="alert">', '</div>'); ?>
                            </div>
                            <?php endforeach; ?>
    ...
    <div class="copyright">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <p class="p-small">Copyright © 2020 <a href="/">Universitas Siber Asia</a></p>
                </div> <!-- end of col -->
            </div> <!-- enf of row -->
        </div> <!-- end of container -->
    ...
    <!-- Scripts -->
    <script src="<?= base_url(); ?>assets/home/event/htc/js/jquery.min.js"></script> <!-- jQuery for Bootstrap's JavaScript plugins -->
    <script src="<?= base_url(); ?>assets/home/event/htc/js/popper.min.js"></script> <!-- Popper tooltip library for Bootstrap -->
    <script src="<?= base_url(); ?>assets/home/event/htc/js/bootstrap.min.js"></script> <!-- Bootstrap framework -->
    <script src="<?= base_url(); ?>assets/home/event/htc/js/jquery.easing.min.js"></script> <!-- jQuery Easing for smooth scrolling between anchors -->
    <script src="<?= base_url(); ?>assets/home/event/htc/js/swiper.min.js"></script> <!-- Swiper for image and text sliders -->
    <script src="<?= base_url(); ?>assets/home/event/htc/js/jquery.magnific-popup.js"></script> <!-- Magnific Popup for lightboxes -->
    <script src="<?= base_url(); ?>assets/home/event/htc/js/validator.min.js"></script> <!-- Validator.js - Bootstrap plugin that validates forms -->
    <script src="<?= base_url(); ?>assets/home/event/htc/js/scripts.js"></script> <!-- Custom scripts -->
</body>
