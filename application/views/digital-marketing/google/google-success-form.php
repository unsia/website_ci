...
<head>
	...
	<script>
		gtag('event', 'conversion', {
			'send_to': 'AW-834244886/S0PhCPjtnvABEJai5o0D'
		});
	</script>
			...
			<div class="account-form-inner">
				<div class="account-container">
					<div class="error-page">
						...
						<br>
						<hr>
						<h5>Data Anda Berhasil Dikirim</h5>
						<p>Terimakasih telah mengisi form. Kami akan menghubungi anda melaui nomor 0812-1373-2772 /
							0812-1880-7163. Silahkan menunggu ya kak. Semoga sehat selalu, salam hangat untuk keluarga
							di rumah.</p>
						<div class="">
